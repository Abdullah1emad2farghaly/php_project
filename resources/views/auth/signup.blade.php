            ...
            <div class="row m-0">
                ...
                <div class="col-lg-6 right px-lg-5">
                    <form class="container m-0 px-lg-4 p-0" method="post" action="{{ route('signup') }}">
                        @csrf
                        <h1 class='pt-4 mb-3' data-aos="fade-left" data-aos-duration="300">Create an account</h1>
                        <p class='mb-4' data-aos="fade-left" data-aos-duration="300">Enter your details below</p>

                        <div class='mb-4' data-aos="fade-left" data-aos-duration="300" data-aos-delay="200">
                        ...
                        <div class='mb-4' data-aos="fade-left" data-aos-duration="300" data-aos-delay="400">
                        ...
                        <div class='mb-4' data-aos="fade-left" data-aos-duration="300" data-aos-delay="600">
                        ...
                        <button herf="" class='mt-4' type='submit' data-aos="fade-left" data-aos-duration="300"
                            data-aos-delay="800">Create
                            Account</button>
                        <div class='mt-4 d-flex' data-aos="fade-left" data-aos-duration="300" data-aos-delay="1000">
