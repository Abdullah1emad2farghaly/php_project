    ...
    <div class="cart-container">
        <form action="{{ route('cart.update') }}" method="POST">
                        ...
                        <tr>
                            <td>
                                <div class="product-info">
                                    <button class="remove-btn" form="delete-form-{{ $product->order_id }}" type="submit">×</button>
            ...
            <div class="cart-footer">
                <div>
                    <button class="btn" type="button" onclick="window.location='{{ url('/') }}'">Return To Shop</button>
                </div>
                <div>
        ...
        <form action="{{ route('cart.destroy', $product->order_id) }}" method="POST" id="delete-form-{{ $product->order_id }}"
            style="display: none;">
            @csrf
            @method('DELETE')
        </form>
